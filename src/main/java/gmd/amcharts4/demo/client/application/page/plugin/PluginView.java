...
public class PluginView extends ViewImpl implements PluginPresenter.MyView {

    interface Binder extends UiBinder<Widget, PluginView> {
    }
    ...
    @Inject
    PluginView(Binder uiBinder) {
        initWidget(uiBinder.createAndBindUi(this));
    }

    @Override
    public void build(List<ChartDemo> demos) {
        ChartRenderer.render(NameTokens.PLUGINS, chartContainer, demos);
    }
}
